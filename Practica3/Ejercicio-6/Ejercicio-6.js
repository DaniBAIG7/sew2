...
class CalculadoraDistancia {
    ...
    calcularDistancia() {
        let lat1 = parseFloat(document.getElementById('coordenada1Latitud').value);
        let lon1 = parseFloat(document.getElementById('coordenada1Longitud').value);

        let lat2 = parseFloat(document.getElementById('coordenada2Latitud').value);
        let lon2 = parseFloat(document.getElementById('coordenada2Longitud').value);

        document.getElementById('resultado').value = this.calc(lat1, lon1, lat2, lon2);
        document.getElementById('resultado').value += 'km';
    }
...
var calculadoraDistancia = new CalculadoraDistancia();
...
class TransformarCoordenadas {
    ...
    transformar_a_UTM() {
        ...
        if (isNaN(parseFloat(document.getElementById('coordenadasLongitud').value))) {
        ...
        lon = parseFloat(document.getElementById('coordenadasLongitud').value);
        ...
        if (isNaN(parseFloat(document.getElementById('coordenadasLatitud').value))) {
        ...
        lat = parseFloat(document.getElementById('coordenadasLatitud').value);
        ...
        zone = util.LatLonToUTMXY(util.DegToRad(lat), util.DegToRad(lon), zone, xy);

        /* Set the output.  */

        document.getElementById('coordenadasUTMX').value = xy[0];

        document.getElementById('coordenadasUTMY').value = xy[1];
    ...
    transformar_a_LatLon() {
        ...
        if (isNaN(parseFloat(document.getElementById('coordenadasUTMX').value))) {
        ...
        x = parseFloat(document.getElementById('coordenadasUTMX').value);



        if (isNaN(parseFloat(document.getElementById('coordenadasUTMY').value))) {
        ...
        y = parseFloat(document.getElementById('coordenadasUTMY').value);



        if (isNaN(parseInt(document.getElementById('zone').value))) {
        ...
        if (document.getElementById('hemisferiosur').checked)
        ...
        util.UTMXYToLatLon(x, y, zone, southhemi, latlon);



        document.getElementById('coordenadasLongitud').value = util.RadToDeg(latlon[1]);

        document.getElementById('coordenadasLatitud').value = util.RadToDeg(latlon[0]);
...
var transformarCoordenadas = new TransformarCoordenadas();